// Lab shared helper: theme toggle + persistence + reveal animation.
// Shares the `pevc.theme` localStorage key with the main report so dark mode
// is consistent across the cover, chapters, and lab tools.
(function () {
  const THEME_KEY = 'pevc.theme';
