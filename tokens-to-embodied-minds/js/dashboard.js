...
(function () {
  ...
  // --- Chapter manifest: read from window.__CHAPTERS_META__ injected by the generator ---
  const CHAPTERS = (window.__CHAPTERS_META__ || []).map(function (c) {
    return { num: c.num, slug: c.slug, title: c.title };
  });
